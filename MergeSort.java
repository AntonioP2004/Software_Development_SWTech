...
public class MergeSort {
  ...
  public static <E extends Comparable<E>> void mergeSort(E[] firstHalf2) {
    if (firstHalf2.length > 1) {
      // Merge sort the first half
      E[] firstHalf = (E[])new Comparable[firstHalf2.length / 2];
      System.arraycopy(firstHalf2, 0, firstHalf, 0, firstHalf2.length / 2);
      mergeSort(firstHalf);

      // Merge sort the second half
      int secondHalfLength = firstHalf2.length - firstHalf2.length / 2;
      ...
      E[] temp = merge(firstHalf, secondHalf, firstHalf2);
      System.arraycopy(temp, 0, firstHalf2, 0, temp.length);
    }
  }
